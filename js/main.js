...
//  Section Perfect_menu
   ...
   parent3.addEventListener('click', (event) => {
      ...
      if (target.classList.contains('gender-item')) {
         ...
         if(menuItem3[0].classList.contains('gender-item-acvtive')){ 
            svgBg[0].setAttributeNS(null,"fill","#fff");
         } else {
            svgBg[1].setAttributeNS(null,"fill","#fff");
         };
      };
   })
   ...
   // buttonTopUp.addEventListener('click', function () {
   //    modalForm.classList.add('js-mod-none');
   // });
